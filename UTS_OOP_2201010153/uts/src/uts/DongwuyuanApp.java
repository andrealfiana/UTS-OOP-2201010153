...
/**
 *
 * @author 2201010153_I Kadek Andre Alfiana
 * TGL : 2024-05-12
 */
public class DongwuyuanApp {
     private static final int MAX_PENGUNJUNG = 100;
    private static DongwuyuanVisitor[] pengunjung = new DongwuyuanVisitor[MAX_PENGUNJUNG];
    ...
    private static void catatPengunjung() {
        if (jumlahPengunjung < MAX_PENGUNJUNG) {
            ...
            pengunjung[jumlahPengunjung] = new DongwuyuanVisitor(nama);
            jumlahPengunjung++;
